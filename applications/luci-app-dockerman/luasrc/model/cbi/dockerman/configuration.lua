...
if nixio.fs.access("/usr/bin/dockerd") and not m.uci:get_bool("dockerd", "dockerman", "remote_endpoint")  then
	...
	o:value("https://registry.cn-hangzhou.aliyuncs.com", "https://registry.cn-hangzhou.aliyuncs.com")
	o:value("https://registry.cn-shenzhen.aliyuncs.com", "https://registry.cn-shenzhen.aliyuncs.com")
	o:value("https://registry.cn-guangzhou.aliyuncs.com", "https://registry.cn-guangzhou.aliyuncs.com")
	o:value("https://registry.cn-chengdu.aliyuncs.com", "https://registry.cn-chengdu.aliyuncs.com")
	o:value("https://mirror.ccs.tencentyun.com", "https://mirror.ccs.tencentyun.com")
	o:value("https://dockerhub.azk8s.com", "https://dockerhub.azk8s.com")
	o:value("https://docker.nju.edu.cn", "https://docker.nju.edu.cn")
	o:depends("remote_endpoint", 0)
	o.forcewrite = true
