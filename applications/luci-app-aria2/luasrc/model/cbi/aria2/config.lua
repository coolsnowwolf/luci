...
if aria2.bt then
	...
	o=s:taboption("bt", ListValue,"update_time",translate("Auto update bt_tracker"))
	o:value("",translate("Close"))
	for t=0,23 do
	o:value(t,translate(t))
	end
	o.default="Close"
	o.datatype=uinteger

	o=s:taboption("bt",Value,"bt_tracker_url",translate("bt_tracker URL"))
	o.default="https://ngosang.github.io/trackerslist/trackers_all.txt"
	o.description = translate("If you do not set the auto save task<br/>the auto update may cause the download task to be lost<br/>Please update manually when there is no download task.")

	o=s:taboption("bt", Button,"_add",translate("Manual update"))
	o.inputtitle=translate("Manual update")
	o.write = function()
		luci.sys.call("sh /usr/bin/trackers-list-aria2")
	end
