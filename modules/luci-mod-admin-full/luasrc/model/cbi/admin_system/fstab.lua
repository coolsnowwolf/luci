...
o = s:option(Flag, "check_fs", translate("Automatically check filesystem for errors before mounting"), translate("Automatically check filesystem for errors before mounting"))
o.default = o.disabled
o.rmempty = false
