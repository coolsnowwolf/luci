...
assert.deepEqual(view.rateValue([], {}, 'connections', mac), [-1,'-']);
assert.deepEqual(view.rateValue([], {connections:{[mac]:6}}, 'connections', mac, false), [0,'0']);
assert.deepEqual(view.rateValue([], {}, 'connections', mac, false), [0,'0']);
assert.deepEqual(view.rateValue([], {connections:{[mac]:6}}, 'connections', mac, true), [6,'6']);
